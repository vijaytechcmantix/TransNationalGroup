...
const Kiosk =(props)=>
{
    ...
    return <>
          <div className="main-wrapper">
                        ...
                        <section className="customer-count-container ms-4">
                            <div className="row">
                                ...
                                <div className="col-lg-4 col-6 pe-0">
                                    ...
                                    <KioskCusomerList setActiveCustomerID={setActiveCustomerID}/>

                                </div>

                                
                                <div className="col-lg-8 col-6">
                                    <KioskList setKioskPopupDetails={set_KioskPopupDetails} CustomerID={customerID} UserID={userDetails?.userDetails?.UserID || ''}/>
                                </div>
            ...
            {/* <KioskModalPopupOne/> */}
            <KioskModalPopupOne UserID={users?.userDetails?.UserID || ''} kioskPopupDetails={kioskPopupDetails} />
