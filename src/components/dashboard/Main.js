...
const DashboardTopbar=(props)=>
{
    ...
    useEffect(()=>{
        Promise.all([
            getKioskOfflineTotal().then((result)=>{
                return result;
            }).catch((error)=>{
                console.log(error);
            }),
            getKioskStickerLowTotal().then((result)=>{
                return result;
            }).catch((error)=>{
                console.log(error);
            }),
            getKioskUPSActivatedTotal().then((result)=>{
                return result;
            }).catch((error)=>{
                console.log(error);
            })
  ...
  return  <>
            ...
            <div className="dashboard-top-bar px-3 py-2 d-flex justify-content-between align-items-center mb-3">
                ...
                <div className="dashboard-count d-flex">
                    {/* <!-- Dashboard Details  --> */}
                    <div 
                        className="dashboard-count-sub-container d-flex ps-2 pe-4 py-2 me-3 align-items-center"
            ...
            <DashboardModal  
                title={PopupModal.title + ' User List'} 
...
const DashboardCustomer=({setKioskDataList, logOutDashboard})=>
{
    ...
    return  <>
            ...
            <div className="dashboard-customer-list-container p-3 w-100">
                ...
                <div className="dashboard-customer-list">
                    {
                        tempCustomerList.map((cust,index)=>{
                            return(
                                    <div key={cust.CompanyID} onClick={()=>{showKiosList(index,cust.CompanyID)}} className={activeCustomer == cust.CompanyID ? "single-customer-list-container active d-flex py-2 px-3" : "single-customer-list-container d-flex py-2 px-3" }>
...
const DashboardKios=({CompanyID, setKioskListId})=>
{
    ...
    return  <>
            {/* <!-- Kiosk container --> */}
            <div className="dashboard-kiosk-list-container p-3 w-100">
...
const DashboardKiosStatus=({KioskID})=>
{
  ...
  return  <>
            ...
            <div className="dashboard-kiosk-status-container p-3 w-100">
                        ...
                        <div className={'col-6'}>
                            <div className="row">
                                <div className="col-12">
                                    <div className={`box-1 box-card status-${ kisokBox?.[0]?.['Enable'] ? (kisokBox[0]['Enable'] == "Yes" ? "enabled" : "disabled") : ""  }`}>
                                ...
                                <div className="col-6 pr-0">
                                    <div className="box-col-one-container d-flex flex-column">
                                        <div className={`box-2 box status-${ kisokBox?.[1]?.['Enable'] ? (kisokBox[1]['Enable'] == "Yes" ? "enabled" : "disabled") : "" }`}>
                                            <div className="box-heading">
                                                2
                                            </div>
                                            <div className="box-content">
                                        ...
                                        <div className={`box-3 box status-${ kisokBox?.[2]?.['Enable'] ? (kisokBox[2]['Enable'] == "Yes" ? "enabled" : "disabled") : "" }`}>
                                            <div className="box-heading">
                                                3
                                            </div>
                                            <div className="box-content">
                                        ...
                                        <div className={`box-4 box status-${ kisokBox?.[3]?.['Enable'] ? (kisokBox[3]['Enable'] == "Yes" ? "enabled" : "disabled") : "" }`}>
                                            <div className="box-heading">
                                                4
                                            </div>
                                            <div className="box-content">
                                        ...
                                        <div className={`box-5 box status-${ kisokBox?.[4]?.['Enable'] ? (kisokBox[4]['Enable'] == "Yes" ? "enabled" : "disabled") : "" }`}>
                                            <div className="box-heading">
                                                5
                                            </div>
                                            <div className="box-content">
                                        ...
                                        <div className="no-storage-one no-storage">
