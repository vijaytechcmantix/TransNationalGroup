export function FirstSlave({kisokBox}){
    ...
    return( <div className={`col-3 d-flex flex-column`}>
                    <div className={`box-9 box-card status-${ kisokBox?.[7]?.['Enable'] ? (kisokBox[7]['Enable'] == "Yes" ? "enabled" : "disabled") : "" }`}>
                    ...
                    <div className="no-storage-two no-storage">
...
export function SecondSlave({kisokBox}){
    return( <div className="col-3 d-flex flex-column">
                    <div className={`box-9 box-card status-${ kisokBox?.[13]?.['Enable'] ? (kisokBox[13]['Enable'] == "Yes" ? "enabled" : "disabled") : "" }`}>
                        <div className="box-heading">
                            14
                        </div>
