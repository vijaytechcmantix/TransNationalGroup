            ...
            <div className="user-customer-list">
                {
                    tempCustomerList.map((item)=>{
                        return(
                            <div key={item.CompanyID} onClick={()=>{changeActiveCustomerList(item.CompanyID)}} className={activeCustomer == item.CompanyID ? "single-customer-list-container active d-flex py-2 px-3" : "single-customer-list-container d-flex py-2 px-3" }>
